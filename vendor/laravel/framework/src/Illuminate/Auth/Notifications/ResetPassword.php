...
class ResetPassword extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(Lang::get('Уведомление об изменении пароля'))
            ...
            ->line(Lang::get('Ссылка для восстановления истечет в течении :count минут.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
