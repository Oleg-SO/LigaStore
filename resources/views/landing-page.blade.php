	            		...
	            		<div class="col-lg-12">
	            			<div class="slider__content">
		            			<div class="contentbox">
		            				<h2>Покупки <span>в рассрочку </span></h2>
		            				<h2>Делай  <span>Выбор </span></h2>
		            				<h2>Вместе <span>с нами </span></h2>
				                   	<a class="shopbtn" href="#">Перейти</a>
		            			</div>
	            			</div>
	            		</div>
	            	</div>
	            ...
	            <div class="container">
	            	<div class="row">
	            		<div class="col-lg-12">
	            			<div class="slider__content">
		            			<div class="contentbox">
		            				<h2>Покупай <span>свой </span></h2>
		            				<h2>Любимый <span>инструмент </span></h2>
		            				<h2>У <span>нас </span></h2>
				                   	<a class="shopbtn" href="#">Перейти</a>
		            			</div>
	            			</div>
	            		</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section__title text-center">
							<h2 class="title__be--2">Акционные <span class="color--theme">Товары</span></h2>
							<p>Покупки в рассрочку и в кредит в магазине LIGA store с доставко до вашего дома </p>
						</div>
					</div>
				</div>
					...
					<div class="product product__style--3">
						<div class="col-lg-3 col-md-4 col-sm-6 col-12">
							<div class="product__thumb">
									...
									<a class="second__img animation1" href="{{ route('shop.show', $product->slug) }}"><img src="storage/{{$product->name}}" alt="{{ $product->name }}"></a>
								<div class="hot__box">
                            ...
                            <h4><a href="{{ route('shop.show', $product->slug) }}">{{ $product->name }}</a></h4>
                                <ul class="prize d-flex">
                                    ...
                                    <!-- <li class="old_prize">{{ presentPrice($product->price - (($product->price / 100) * 10)) }}</li> -->
								</ul>
								<div class="action">
