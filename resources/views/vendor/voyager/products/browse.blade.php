                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                                ...
                                                @if($row->type == 'image')
                                                    <img src="@if( !filter_var($data->{$row->field}, FILTER_VALIDATE_URL)){{ asset(Voyager::image( $data->{$row->field} )) }}@else{{ $data->{$row->field} }}@endif" style="width:100px">
                                                ...
                                                @elseif($row->type == 'multiple_images')
                                                    ...
                                                    @if($images)
                                                        ...
                                                        @foreach($images as $image)
                                                            <img src="@if( !filter_var($image, FILTER_VALIDATE_URL)){{ asset(Voyager::image( $image )) }}@else{{ $image }}@endif" style="width:50px">
                                                        @endforeach
                                                    @endif
                                                @else
                                                    @include('voyager::multilingual.input-hidden-bread-browse')
